...
%>
	<tr><td colspan="4">MVC 게시판</td><td>글 개수 : ${listcount }</td></tr>
...
<%
	for(int i=0;i<boardList.size();i++){ //for 반복문의 끝은 61번 라인
...
%>
	<tr>
		...
		<td>
			...
			<%}else{ %>
				▶
			<%} %>  <!-- 답변글일 경우 레벨에 따라서 들여쓰기를 해주는 구문이다. -->
